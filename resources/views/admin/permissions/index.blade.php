    ...
    <div class="bg-white shadow rounded overflow-hidden dark:white-800">
        ...
        <table class="w-full">
            <thead class="bg-gray-100 dark:bg-gray-700 border-b dark:border-gray-600">
                <tr>
                    <th class="p-3 text-left text-gray-600 dark:text-gray-300 font-semibold">ID</th>
                    <th class="p-3 text-left text-gray-600 dark:text-gray-300 font-semibold">Name</th>
                    <th class="p-3 text-left text-gray-600 dark:text-gray-300 font-semibold">Description</th>
                    <th class="p-3 text-left text-gray-600 dark:text-gray-300 font-semibold w-48">Actions</th>
                </tr>
            </thead>
