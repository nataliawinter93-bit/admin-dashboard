        ...
        <table class="w-full">
            <thead>
                <tr class="border-b bg-gray-50 dark:bg-gray-700">
                    <th class="p-3 text-left text-gray-700 dark:text-gray-300 font-semibold">ID</th>
                    <th class="p-3 text-left text-gray-700 dark:text-gray-300 font-semibold">Name</th>
                    <th class="p-3 text-left text-gray-700 dark:text-gray-300 font-semibold">Slug</th>
